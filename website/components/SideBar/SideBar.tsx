...
export default function SideBar({cars, selectedCar, onSelectCar, dashboradPage, setDashboardPage }: SideBarProps) {
    return (
        <div className="h-full bg-[#131413] text-white w-[100%] py-2">
            <div className="divide-y w-full">
                ...
                <div className="py-8 px-6 flex flex-col items-start gap-y-6">
                    ...
                    <button onClick={() => setDashboardPage("auction")}>
                        <div className="flex gap-3 items-center ">
                            <Handshake className={`${dashboradPage == "auction" ? `text-[#7FEA52]` : `text-neutral-400`}`} size={18} />
                            <p className={`text-sm ${dashboradPage == "auction" ? `text-[#7FEA52]` : `text-neutral-400`}`}>Auction</p>
                        </div>
                    </button>
